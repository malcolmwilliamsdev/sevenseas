      ...
      <div data-custom-class="body">
        <div>
          <strong>
            <span style={{ fontSize: "26px" }}>
              <span className={styles.title}>COOKIE POLICY</span>
            </span>
          </strong>
        </div>
        <div>
            ...
            <strong>
              <span style={{ fontSize: "15px" }}>
                <span className={styles.subtitle}>
                  Last updated <bdt className="question">July 27, 2023</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              <span className={styles.body_text}>
                ...
                <bdt className="question">Seven Seas Power Washing LLC</bdt>{" "}
                (&quot;
            ...
            <span style={{ color: "rgb(0, 58, 250)", fontSize: "15px" }}>
              <span className={styles.body_text}>
                <bdt className="question">
                  <a
                    href="http://www.sevenseaspw.com"
                    target="_blank"
                    className={styles.link}
                  >
                    http://www.sevenseaspw.com
                  </a>
                </bdt>
              </span>
            </span>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)", fontSize: "15px" }}>
              <strong>
                <span className={styles.heading_1}>What are cookies?</span>
              </strong>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)", fontSize: "15px" }}>
              <strong>
                <span className={styles.heading_1}>Why do we use cookies?</span>
              </strong>
            </span>
          </span>
        </div>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              <span className={styles.body_text}>
                ...
                refer to these as &quot;essential&quot; or &quot;strictly
                necessary&quot; cookies. Other cookies also enable us to track
                and target the interests of our users to enhance the experience
                on our Online Properties. <bdt className="block-component" />
          ...
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <a
                ...
                target="_blank"
              >
                <span className={styles.link}>Chrome</span>
              </a>
            </span>
          </li>
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <a
                ...
                target="_blank"
              >
                <span className={styles.link}>Internet Explorer</span>
              </a>
            </span>
          </li>
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <a
                ...
                target="_blank"
              >
                <span className={styles.link}>Firefox</span>
              </a>
            </span>
          </li>
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <a
                ...
                target="_blank"
              >
                <span className={styles.link}>Safari</span>
              </a>
            </span>
          </li>
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <a
                ...
                target="_blank"
              >
                <span className={styles.link}>Edge</span>
              </a>
            </span>
          </li>
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <a
                ...
                target="_blank"
              >
                <span className={styles.link}>Opera</span>
              </a>
            </span>
          </li>
        </ul>
            ...
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span className={styles.body_text}>
                  ...
                  including them
                  <bdt className="statement-end-if-in-editor" />. This allows
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span className={styles.body_text}>We may update&nbsp;</span>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span className={styles.body_text}>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span className={styles.body_text}>
                  ...
                  <bdt className="question">sevenseasnm@sevenseaspw.com</bdt> or
                  by post to:
                </span>
              </span>
            </span>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <bdt className="question">
              <span className={styles.body_text}>__________</span>
            </bdt>
            <span className={styles.body_text}>
              <bdt className="block-component" />
            </span>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span className={styles.body_text}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <bdt className="question">Albuquerque</bdt>
              <bdt className="block-component" />
              <bdt className="block-component" />,{" "}
              <bdt className="question">NM</bdt>
              <bdt className="statement-end-if-in-editor" />
              <bdt className="block-component" />
              <bdt className="block-component" />
              <bdt className="block-component" />
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span className={styles.body_text}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <bdt className="statement-end-if-in-editor">
                Phone: <bdt className="question">+1(505)-503-0523</bdt>
              </bdt>
            </span>
          </span>
          <span className={styles.body_text}>
